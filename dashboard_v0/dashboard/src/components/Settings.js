    ...
    return (
        <div className="dashboard container">
            ...
            <div className='system-prompt-container'>
                {config.model === "llama" || config.model === "llama3" ? (config.systemPrompt !== null ? config.systemPrompt : config.defaultSystemPrompt) : "Mistral-7B V2 does not support system message."}
                {isBusy && 
                <div>
            ...
            <div style={{alignItems: "center", display: "flex"}}><img src={config.model === "llama" || config.model == "llama3" ? llamaBoxer : mistralBoxer} alt="Placeholder" height="60vw" style={{transform: config.model === "mistral" ? "scaleX(-1)": ""}} />: 
