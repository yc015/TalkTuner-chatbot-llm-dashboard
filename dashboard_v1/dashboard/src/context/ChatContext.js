...
import { API_PORT, API_IP, STATUS_CREATED, BACKEND_ADDR } from '../helpers/constants.js';
...
const defaultControlYouModelData = {
    gender:{
        male: 0.0,
        female: 0.0,
        other: 0.0,
...
var data = {
    ...
    youModelPrompt: defaultYouModelData,  // Add prompt-based you model
    historyYouModel: [],
    historyYouModelPrompt: [],  // Add prompt-based history
    controlYouModel: defaultControlYouModelData,
...
const ChatProvider = props => {
    ...
    const value = { chatInfo, setChatInfo, updateControlYouModelTrait, setControlYouModelTraitStatus, token, setToken};
